(() => {
  ...
  // extensions/gwp-checker/src/Checkout.jsx
  ...
  // extensions/gwp-checker/node_modules/@shopify/ui-extensions/build/esm/utilities/registration.mjs
  ...
  // extensions/gwp-checker/node_modules/@shopify/ui-extensions/build/esm/surfaces/checkout/extension.mjs
  var extension = createExtensionRegistrationFunction();

  // extensions/gwp-checker/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/render.mjs
  ...
  // extensions/gwp-checker/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/context.mjs
...
${errorInfo.componentStack}`);
  ...
  // extensions/gwp-checker/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/api.mjs
  var import_react6 = __toESM(require_react(), 1);

  // extensions/gwp-checker/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/errors.mjs
  ...
  // extensions/gwp-checker/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/subscription.mjs
  ...
  // extensions/gwp-checker/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/attributes.mjs
  ...
  // extensions/gwp-checker/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/cost.mjs
  function useTotalAmount() {
    return useSubscription(useApi().cost.totalAmount);
  }

  // extensions/gwp-checker/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/cart-lines.mjs
  ...
  var Checkout_default = reactExtension("purchase.checkout.block.render", () => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(App, {}));
  ...
  function App() {
    ...
    const { cost } = useApi();
    const removeFromCart = (0, import_react8.useCallback)((items) => {
      return items.map((line) => applyCartLinesChange({
        type: "removeCartLine",
        id: line.id,
        quantity: line.quantity
      }));
    }, [applyCartLinesChange]);
    const addToCart = (0, import_react8.useCallback)((items) => {
      return items.map((line) => applyCartLinesChange({
        type: "addCartLine",
    ...
    const memoizeGwpItems = (0, import_react8.useMemo)(() => {
      const cartTotal = cost.totalAmount.current.amount;
      const gwpInCart = cartLines.filter((lineItem) => lineItem.attributes.some((attr) => attr.key === "_gwp"));
      const gwpIdInCart = gwpInCart.map((lineItem) => lineItem.merchandise.id);
      const itemsToAdd = gwpConditions.filter((condition) => cartTotal >= condition.threshold && !gwpIdInCart.includes(condition.id));
      const itemsToRemove = gwpInCart.filter((lineItem) => gwpConditions.find((condition) => condition.id === lineItem.merchandise.id && cartTotal <= condition.threshold));
    ...
    (0, import_react8.useEffect)(() => {
      ...
      Promise.all([addToCartPromise, removeFromCartPromise]).then(() => console.log("GWPs updated")).catch((error) => console.error("Error updating GWPs:", error));
    }, [memoizeGwpItems]);
    return null;
  }
})();
//# sourceMappingURL=gwp-checker.js.map
